...
Scenario: sort movies alphabetically
  ...
  Then I should see "Chocolat" before "Raiders"
  Then I should see "Raiders" before "The Help"
  Then I should see "The Help" before "The Incredibles"
  Then I should see "The Incredibles" before "The Terminator"
  Then I should see "The Terminator" before "When Harry Met"

Scenario: sort movies in increasing order of release date
  When I follow "Release Date"
  # your steps here
  Then I should see "2001: A Space" before "Raiders"
  Then I should see "Raiders" before "The Terminator"
  Then I should see "The Terminator" before "When Harry Met"
  Then I should see "When Harry Met" before "Aladdin"
